...
use scrappy_codec::BytesCodec;
use scrappy_service::{fn_factory_with_config, fn_service, IntoService, Service};
use scrappy_testing::TestServer;
use scrappy_utils::mpsc;
use bytes::{Bytes, BytesMut};
use futures::future::ok;

use scrappy_ioframe::{Builder, Connect, FactoryBuilder};
...
async fn test_basic() {
    ...
    let conn = scrappy_connect::default_connector()
        .call(scrappy_connect::Connect::with(String::new(), srv.addr()))
        .await
        .unwrap();
