...
use scrappy::dev::{ServiceRequest, ServiceResponse};
use scrappy::http::{header::SET_COOKIE, HeaderValue};
use scrappy::{Error, HttpMessage, ResponseError};
...
///
/// ```rust
/// use scrappy_session::CookieSession;
