...
pub trait Responder {
    ...
    ///
    /// ```rust
    /// use scrappy::{HttpRequest, Responder, http::StatusCode};
    ///
    ...
    ///
    /// ```rust
    /// use scrappy::{web, HttpRequest, Responder};
    /// use serde::Serialize;
    ///
    /// #[derive(Serialize)]
    /// struct MyObj {
...
///
/// ```rust
/// use scrappy::{Either, Error, HttpResponse};
///
