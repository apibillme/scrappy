...
use scrappy_http::{Error, Extensions, Response};
use scrappy_router::IntoPattern;
...
///
/// ```rust
/// use scrappy::{web, App, HttpResponse};
///
/// fn main() {
    ...
    >,
{
    ...
    ///
    /// ```rust
    /// use scrappy::{web, guard, App, HttpResponse};
    ///
    ...
    ///     );
    /// }
    /// # async fn get_handler() -> impl scrappy::Responder { scrappy::HttpResponse::Ok() }
    /// # async fn post_handler() -> impl scrappy::Responder { scrappy::HttpResponse::Ok() }
    /// # async fn delete_handler() -> impl scrappy::Responder { scrappy::HttpResponse::Ok() }
    /// ```
    ...
    ///
    /// ```rust
    /// use scrappy::{web, App, FromRequest};
    ///
    ...
    /// use scrappy::{web, App};
    /// use scrappy::http::{header::CONTENT_TYPE, HeaderValue};
    ///
