...
use scrappy_http::http::{HeaderMap, Method, Uri, Version};
use scrappy_http::{Error, Extensions, HttpMessage, Message, Payload, RequestHead};
use scrappy_router::{Path, Url};
...
impl HttpRequest {
    ...
    /// # use scrappy::{web, App, HttpRequest, HttpResponse};
    /// #
