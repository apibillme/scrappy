...
use scrappy_http::error::{Error, ErrorNotFound};
use scrappy_router::PathDeserializer;
...
///
/// ```rust
/// use scrappy::web::PathConfig;
/// use scrappy::{error, web, App, FromRequest, HttpResponse};
/// use serde_derive::Deserialize;
///
...
#[cfg(test)]
mod tests {
    use scrappy_router::ResourceDef;
