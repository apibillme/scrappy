//! Route match guards.
//!
//! Guards are one of the ways how scrappy-web router chooses a
...
//! and *routes*. scrappy provide several guards by default, like various
...
//!
//! ```rust
//! use scrappy::{web, http, dev, guard, App, HttpResponse};
//!
//! fn main() {
...
use scrappy_http::http::{self, header, uri::Uri};
use scrappy_http::RequestHead;
...
///
/// ```rust
/// use scrappy::{guard, web, App, HttpResponse};
///
/// fn main() {
///     App::new().service(web::resource("/index.html").route(
///         web::route()
...
///
/// ```rust
/// use scrappy::{web, guard::Host, App, HttpResponse};
///
/// fn main() {
///     App::new().service(
...
#[cfg(test)]
mod tests {
    use scrappy_http::http::{header, Method};
