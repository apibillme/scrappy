...
/// enable logger for `scrappy` package to see access log.
...
/// ```
/// ```rust
/// use scrappy::middleware::Logger;
/// use scrappy::App;
///
/// fn main() {
///     std::env::set_var("RUST_LOG", "scrappy=info");
///     env_logger::init();
///
///     let app = App::new()
///         .wrap(Logger::default())
...
mod tests {
    ...
    async fn test_logger() {
        ...
        let req = TestRequest::with_header(
            header::USER_AGENT,
            header::HeaderValue::from_static("scrappy-WEB"),
        )
        .to_srv_request();
