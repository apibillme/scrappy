...
///
/// ```rust
/// use scrappy::middleware::errhandlers::{ErrorHandlers, ErrorHandlerResponse};
/// use scrappy::{web, http, dev, App, HttpRequest, HttpResponse, Result};
///
...
#[cfg(test)]
mod tests {
    use scrappy_service::IntoService;
