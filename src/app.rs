...
use scrappy_http::body::{Body, MessageBody};
use scrappy_http::Extensions;
use scrappy_service::boxed::{self, BoxServiceFactory};
use scrappy_service::{
    ...
    >,
{
    ...
    ///
    /// ```rust
    /// use scrappy::{web, App, HttpRequest, HttpResponse, Result};
    ///
    ...
    /// use scrappy::{middleware, web, App};
