...
use scrappy_http::{Extensions, Response};
use scrappy_router::{ResourceDef, ResourceInfo, Router};
    ...
    >,
{
    ...
    ///
    /// ```rust
    /// use scrappy::{web, guard, App, HttpRequest, HttpResponse};
    ///
    ...
    /// ```rust
    /// use std::cell::Cell;
    /// use scrappy::{web, App, HttpResponse, Responder};
    ///
    /// struct MyData {
    ///     counter: Cell<usize>,
    /// }
    ...
    /// use scrappy::{web, middleware, App, HttpResponse};
    ///
    ...
    ///
    /// ```rust
    /// use scrappy::{web, App, HttpRequest};
    ///
    /// struct AppState;
    ///
