//! Http client errors
pub use scrappy_http::client::{
    ConnectError, FreezeRequestError, InvalidUrl, SendRequestError,
};
pub use scrappy_http::error::PayloadError;
pub use scrappy_http::http::Error as HttpError;
pub use scrappy_http::ws::HandshakeError as WsHandshakeError;
pub use scrappy_http::ws::ProtocolError as WsProtocolError;

use scrappy_http::ResponseError;
use serde_json::error::Error as JsonError;

use scrappy_http::http::{header::HeaderValue, StatusCode};
