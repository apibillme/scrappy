...
pub use scrappy_threadpool::BlockingError;
use scrappy_utils::framed::DispatcherError as FramedDispatcherError;
use scrappy_utils::timeout::TimeoutError;
use bytes::BytesMut;
...
/// for scrappy web operations
///
/// This typedef is generally used to avoid writing out
/// `scrappy_http::error::Error` directly and is otherwise a direct mapping to
/// `Result`.
pub type Result<T, E = Error> = result::Result<T, E>;

/// General purpose scrappy web error.
///
/// An scrappy web error is used to carry errors from `failure` or `std::error`
/// through scrappy in a convenient way.  It can be created through
/// converting errors with `into()`.
///
/// Whenever it is created from an external object a response error is created
/// for it that can be used to create an http response from it this means that
/// if you have access to an scrappy `Error` you can always get a
...
impl ResponseError for scrappy_connect::ssl::openssl::SslError {}

#[cfg(feature = "openssl")]
/// `InternalServerError` for `openssl::ssl::HandshakeError`
impl<T: std::fmt::Debug> ResponseError for scrappy_tls::openssl::HandshakeError<T> {}
