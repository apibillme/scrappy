...
use scrappy_service::{pipeline_factory, IntoServiceFactory, Service, ServiceFactory};
use bytes::Bytes;
...
mod openssl {
    use super::*;
    use scrappy_tls::openssl::{Acceptor, SslAcceptor, SslStream};
    use scrappy_tls::{openssl::HandshakeError, SslError};
...
mod rustls {
    use super::*;
    use scrappy_tls::rustls::{Acceptor, ServerConfig, Session, TlsStream};
    use scrappy_tls::SslError;
    use std::io;
