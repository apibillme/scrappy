...
use scrappy_connect::resolver::ResolveError;
use derive_more::{Display, From};

#[cfg(feature = "openssl")]
use scrappy_connect::ssl::openssl::{HandshakeError, SslError};
...
impl From<scrappy_connect::ConnectError> for ConnectError {
    fn from(err: scrappy_connect::ConnectError) -> ConnectError {
        match err {
            scrappy_connect::ConnectError::Resolver(e) => ConnectError::Resolver(e),
            scrappy_connect::ConnectError::NoRecords => ConnectError::NoRecords,
            scrappy_connect::ConnectError::InvalidInput => panic!(),
            scrappy_connect::ConnectError::Unresolverd => ConnectError::Unresolverd,
            scrappy_connect::ConnectError::Io(e) => ConnectError::Io(e),
        }
    }
}
