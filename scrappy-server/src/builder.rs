...
use scrappy_rt::time::{delay_until, Instant};
use scrappy_rt::{spawn, System};
...
impl ServerBuilder {
    ...
    where
        F: ServiceFactory<scrappy_rt::net::UnixStream>,
        N: AsRef<str>,
    ...
    fn handle_cmd(&mut self, item: ServerCommand) {
        match item {
            ...
            ServerCommand::Signal(sig) => {
                // Signals support
                // Handle `SIGINT`, `SIGTERM`, `SIGQUIT` signals and stop scrappy system
                match sig {
                    Signal::Int => {
